...
RSpec.describe User, type: :model do
  ...
  describe 'ユーザー新規登録' do
    ...
    context '新規登録できない場合' do
      ...
      it 'last_nameは全角（漢字・ひらがな・カタカナ）以外では保存できない' do
        @user.last_name = 'Ernser'
        @user.valid?
      ...
      it 'first_nameは全角（漢字・ひらがな・カタカナ）以外では保存できない' do
        @user.first_name = 'Kaci'
        @user.valid?
      ...
      it 'last_name_kanaは全角（カタカナ）以外では保存できない' do
        @user.last_name_kana = 'まつした'
        @user.valid?
      ...
      it 'first_name_kanaは全角（カタカナ）以外では保存できない' do
        @user.first_name_kana = 'こうへい'
        @user.valid?
